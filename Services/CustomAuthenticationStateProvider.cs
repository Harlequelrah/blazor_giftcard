...
namespace blazor_giftcard.Services
{
    ...
    public class CustomAuthenticationStateProvider : AuthenticationStateProvider, IAsyncDisposable
    {
        ...
        {
            var response = await _httpClient.GetStringAsync("https://localhost:7168/api/User/get-refresh-token");
            return response;
        }
        ...
        public async Task<bool> TryRefreshTokenAsync()
        {
            ...
            var refreshTokenResponse = await _httpClient.PostAsJsonAsync("https://localhost:7168/api/User/refresh-token", refreshRequest);
